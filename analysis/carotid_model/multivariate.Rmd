...
```{r}
ebl_t1s_pred <- lm(`trial 1 ebl` ~ Group + generalconfidencepre + generalconfidencepost + carotidconfidencepre + carotidconfidencepost, data=pred_logisit_data)
ebl_t2s_pred <- lm(`trial 2 ebl` ~ Group + generalconfidencepre + generalconfidencepost + carotidconfidencepre + carotidconfidencepost, data=pred_logisit_data)
